...
def get_parameters():
    ...
    parameters = {
        ...
        "appid": "430bff2dbcf98539d1f52ea4ab99f4cf",            # I hope I'm allowed to just leave my API-key here
        "cnt": 1,
        "units": "metric"
...
def print_beverage(temp):
    ...
    if temp < 10:
        ...
        print("You could probably get away with selling any beverage, considering the average temp.")
